/******/ (() => { // webpackBootstrap
/*!*****************************************!*\
  !*** ./src/blocks/store-policy/view.js ***!
  \*****************************************/
/**
 * FRONTEND ONLY — dynamic policy injection
 */
window.addEventListener('DOMContentLoaded', () => {
  if (!window.StoreInfo || !StoreInfo.activeModules?.includes('store-policy')) {
    document.querySelectorAll('.multivendorx-store-policy-block').forEach(block => block.remove());
    return;
  }
  ...
  document.querySelectorAll('.multivendorx-store-policy-block').forEach(block => {
